...
plt.xlabel('Tamano de la red $L$', fontsize = 12)
plt.xticks(fontsize=12)
plt.ylabel('Dispersion', fontsize = 12)
plt.yticks(fontsize=12)
plt.title('Dispersion en los valores de $p_c$ en funcion del tamano', fontsize = 15)
plt.grid(True)
plt.show()
fig = plt.figure()
plt.close(fig)
...
plt.xlabel('Tamano de la red $L$', fontsize=12)
plt.ylabel('Probabilidad critica', fontsize=12)
plt.title('Probabilidad critica $p_c$ en funcion del tamano', fontsize=20)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.grid(True)
plt.show()
